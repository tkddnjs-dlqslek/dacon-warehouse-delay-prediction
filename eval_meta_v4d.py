"""
Meta v4d: push limits with mc50/mc30 + investigate where OOF improvements come from.
Also try: per-fold residual correlation analysis.
"""
...
def build_meta_v4c(base_pred, bdict, pos, clf_p, agree5, agree7):
    ...
    return np.column_stack([
        ...
        pos**2 / (24.0**2),
        m37, radj,
        m37 - base_pred, radj - base_pred, m37 - oracle_mean,
    ])
...
prev_best = 8.34621
print(f"\n[v4d mc50/mc30 push] prev_best={prev_best:.5f}", flush=True)

configs = [
    (500,  0.05, 30,   3.0, 15, 'mc30_r3'),
    (500,  0.05, 50,   3.0, 15, 'mc50_r3'),
    (500,  0.05, 50,   5.0, 15, 'mc50_r5'),
    (500,  0.05, 50,   8.0, 15, 'mc50_r8'),
    (500,  0.05, 50,   2.0, 15, 'mc50_r2'),
    (500,  0.05, 100,  3.0, 15, 'mc100_r3'),  # v4c best single
    (500,  0.05, 100,  5.0, 15, 'mc100_r5'),  # v4c #2
    (500,  0.05, 100,  8.0, 15, 'mc100_r8'),  # v4c #3
    (800,  0.03, 50,   3.0, 15, 'lr3_mc50'),
    (500,  0.05, 50,   3.0, 31, 'mc50_nl31'),
]
...
fname = f'submission_meta_v4d_OOF{save_mae:.5f}.csv'
